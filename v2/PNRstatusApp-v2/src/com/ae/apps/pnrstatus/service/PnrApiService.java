...
public class PnrApiService implements IStatusService {
	...
	@Override
	public PNRStatusVo getResponse(String pnrNumber) throws JSONException,
			StatusException, IOException {
		...
		String response 	= Utils.getWebResult(searchUrl);
	...
	public String getServiceUrl(String pnrNumber) {
	...
	public PNRStatusVo parseResponse(String responseString)
			throws JSONException, StatusException
	{
		...
		if(ticketStatus.equals(PNRStatus.OK))
		{
			...
			String trainNo 		= Utils.getTrainNo(dataObject.getString("train_number") );
			...
			for(int i = 0; i <passengersArray.length(); i++)
			{
				...
				berthPosition = Utils.getBerthPosition(trainCurrentStatus, 
						trainBookingBerth, ticketClass);
			...
			statusVo.setTrainDest(trainDest);
			...
			statusVo.setTrainCurrentStatus(firstPassengerStatus);
	...
	/*
	 {
	 	...
	 	'data': 
	 	{
	 		'passenger': [
	 			{
	 				'status': 'CNF', 
	 				'seat_number': 'S1  , 59,GN'
	 			}, 
	 			{
	 				'status': 'CNF', 
	 				'seat_number': 'S1  , 62,GN'
	 			}, 
	 			{
	 				'status': 'CNF', 
	 				'seat_number': 'S1  , 58,GN'
	 			}],
	 		'from': 'ERS', 
	 		'alight': 'MAS', 
	 		'pnr_number': '4546028247', 
	 		'train_number': '*16042', 
	 		'to': 'MAS', 
	 		'board': 'ERS', 
