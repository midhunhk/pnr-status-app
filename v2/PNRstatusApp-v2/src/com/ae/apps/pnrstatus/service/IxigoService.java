...
public class IxigoService implements IStatusService {
	...
	protected PNRStatusVo parseResponse(String responseString) throws JSONException, StatusException
	{
		...
		String trainNo 		= Utils.getTrainNo(object.getString("trainNo") );
		...
		for(int i = 0; i <passengersArray.length(); i++)
		{
			...
			berthPosition = Utils.getBerthPosition(trainCurrentStatus, 
					trainBookingBerth, AppConstants.CLASS_UNKNOWN);
