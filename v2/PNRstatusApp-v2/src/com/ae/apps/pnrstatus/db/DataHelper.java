...
public class DataHelper {
    ...
    public Cursor fetchAllPnrNumbers() {
        return mDb.query(TABLE_NAME, new String[] {KEY_ID, KEY_DATA1,
    ...
    public Cursor fetchPnrNumber(long rowId) throws SQLException {
        Cursor mCursor =
            mDb.query(true, TABLE_NAME, new String[] {KEY_ID,
            		KEY_DATA1, KEY_DATA2}, KEY_ID + "=" + rowId, null,
                    null, null, null, null);
    ...
    /**
     * Helper class that extends the SQLiteOpenHelper class
	...
	private static class OpenHelper extends SQLiteOpenHelper
	{
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			Log.w(AppConstants.TAG, "Upgrading database from version " 
					+ oldVersion + " to "
